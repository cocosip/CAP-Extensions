...
namespace Sample.Kafka.Oracle.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        {
            await _capBus.PublishAsync("sample.kafka.oracle", DateTime.Now);
            return Ok();
        }
        ...
        [NonAction]
        [CapSubscribe("sample.kafka.oracle")]
        ...
        [NonAction]
        [CapSubscribe("sample.kafka.oracle", Group = "group.test2")]
